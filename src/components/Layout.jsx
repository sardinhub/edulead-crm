...
import { LayoutDashboard, Users, CalendarDays, Settings, Bell, Search, Menu, Shield, ClipboardList, BarChart2, X, UserPlus, Book, FileSearch, History, MessageCircle, Award, MapPin, Gift, Activity, FileText } from 'lucide-react';
...
const navItems = [
  ...
  { name: 'Catatan Tim', path: '/notes', icon: FileText },
  ...
  { name: 'Log Status', path: '/login-logs', icon: History, managerOnly: true },
